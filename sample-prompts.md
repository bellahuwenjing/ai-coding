...
**Q3:** "What's your launch goal? (Examples: '100 users', 'id: 'prd-mvp',
title: 'PRD MVP Prompt',
summary: '把想法转成可执行的产品需求文档框架。',
category: '产品',
useCases: ['需求定义'],
output: 'PRD',
level: '入门',
tags: ['MVP', '功能清单', '验收标准'],
collectionId: 'vibe-coding-4-step'000 MRR', 'Replace my day job', 'Learn to build apps')"
...
_Why we're waiting: Keeps MVP focused and launchable in [timeframe]_
...
_Status: Draft - Ready for Technical Design_
\`\`\`
...
_Created: [Date]_  
_Status: Ready for Technical Design_  
_Questions? [Contact]_
\`\`\`
