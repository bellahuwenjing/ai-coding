    ...
    return (
        <>
            ...
            <motion.section className="flex flex-col items-center">
                ...
                >
                    <p>Schedule Smarter. Work Better.</p>
                ...
                >
                    Schedule Your People, Vehicles & Equipment — All in One Place
                </motion.h1>
                <motion.p className="text-center text-gray-100 text-base/7 max-w-md mt-6"
                    ...
                    transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
                >
                    Stop juggling spreadsheets. SchedulePro gives you one unified calendar to manage all your resources and eliminate double-bookings.
                </motion.p>
